    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a className="sidebar-brand brand-logo" href="index.html">QUAXOR</a>
        ...
        <ul className="nav">
          ...
          {this._navs.map((item, id) => (
            <li key={id} className={this.isPathActive(item.path) ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <Link className="nav-link" to={item.path}>
                <span className="menu-icon"><i className="mdi mdi-speedometer"></i></span>
                <span className="menu-title"><Trans>{item.label}</Trans></span>
              </Link>
            </li>
          ))}
